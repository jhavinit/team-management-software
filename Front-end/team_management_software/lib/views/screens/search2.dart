          ...
          child: Column(
            ...
            children: [
              ...
              ListView.builder(
                          ...
                          Row(
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: Text(searchResponse![index]['title'],
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                        height: 1.25,
                                        wordSpacing: 4,
                              ...
                              GestureDetector(
                                onTap: () async {
                                  ...
                                  var url = Uri.parse(
                                      'https://www.udemy.com/api-2.0/courses/${searchResponse![index]['id']}');
                                  const String Client_id =
                                      '8A5zSXdl0Zqw9msZT8zjIunfJnxm8NMHB8jkxY84';
                                  const String Client_Secret =
                                      'QjjfkknVPfRBWJnJDMiCwEswkIevljW4JlendE1gv3nJbBjYDsXPV79Prz4dR7B58KYb5rDUicbCksxAP2NSZrpui4qlDyPas1K93R3D5Jfd7OT5B4eml1g8T7O8F3oH';
                                  String auth = base64.encode(
                                      utf8.encode('$Client_id:$Client_Secret'));
                                  searchCourse1 = await http.get(url, headers: {
                                    "Authorization": "Basic " + auth
                                  });
                                  if (searchCourse1.statusCode == 200) {
                                    setState(() {
                                      mapResponse1 =
                                          json.decode(searchCourse1.body);
                                      searchResponse1 =
                                          mapResponse1!['visible_instructors'];
                                      print(searchResponse1);
                                      CourseDetail instance = CourseDetail(
                                          imgurl: searchResponse![index]
                                              ['image_480x270'],
                                          title:
                                              mapResponse1!['title'].toString(),
                                          price: mapResponse1!['price_detail']
                                                  ['amount']
                                              .toString(),
                                          url: mapResponse1!['url'].toString(),
                                          instructor: searchResponse1![0]
                                                  ['display_name']
                                              .toString(),
                                          insturl: searchResponse1![0]
                                                  ['image_100x100']
                                              .toString());
                                      //   Navigator.push(
                                      //   context,
                  ...
                  itemCount:
                      searchResponse == null ? 0 : searchResponse!.length)
            ],
          ),
        ));
  }
